...
$sql = "SELECT * FROM sholat_sunnah WHERE jenis_sholat = 'Tahajud' ORDER BY urutan ASC";
$stmt = $pdo->query($sql);
?>
...
<head>
  <meta charset="UTF-8">
  <title>Tatacara & Bacaan Sholat Tahajud</title>
  <style>
    body {
...
<body>
  <h1>Tatacara & Bacaan Sholat Tahajud</h1>
