...
$sql = "SELECT * FROM bacaan_sholat WHERE jenis_sholat = 'Dzuhur' ORDER BY urutan ASC";
$stmt = $pdo->query($sql);
?>
...
<head>
  <meta charset="UTF-8">
  <title>Tatacara & Bacaan Sholat Dzuhur</title>
  <style>
    body {
...
<body>
  <h1>Tatacara & Bacaan Sholat Dzuhur</h1>
