...
$sql = "SELECT * FROM bacaan_sholat WHERE jenis_sholat = 'Maghrib' ORDER BY urutan ASC";
$stmt = $pdo->query($sql);
?>
...
<head>
  <meta charset="UTF-8">
  <title>Tatacara & Bacaan Sholat Maghrib</title>
  <style>
    body {
...
<body>
  <h1>Tatacara & Bacaan Sholat Maghrib</h1>
  ...
  <div class="bacaan-container">
    ...
    <?php endwhile; ?>
    <a href="sholat-fardhu.php" class="btn-kembali">Kembali</a>
  </div>
